...
const en = {
  ...
  debt: {
    ...
    kind: 'Type', kindOnce: 'One-time', kindRecurring: 'Recurring', kindInstallment: 'Installment',
    kindHint: 'One-time = pay once. Recurring = rent / bills / subscriptions (no end). Installment = a loan you pay off (car, house).',
    freq: { weekly: 'Weekly', monthly: 'Monthly', yearly: 'Yearly' },
    perCycle: 'Amount per cycle', perInstallment: 'Amount per installment',
    totalInstallments: 'Total installments', paidInstallments: 'Paid so far',
    installmentOf: (a, b) => `Installment ${a}/${b}`,
    remaining: 'Remaining', remainingBalance: 'Remaining balance', paidOff: 'Paid off 🎉',
    nextDue: 'Next due', payPeriod: 'Pay this period', payInstallment: 'Pay this installment',
  ...
  settings: {
    ...
    shareBackup: 'Back up to cloud', shareFailed: 'Could not share the backup. Try again.',
    savedToDownloads: 'Backup saved to your Downloads folder.',
    importHint: 'Import a previously exported .json, .xlsx or .csv backup.', importDone: 'Import complete.',
...
const th = {
  ...
  debt: {
    ...
    category: 'หมวดหมู่', tags: 'แท็ก',
    kind: 'ประเภท', kindOnce: 'ก้อนเดียว', kindRecurring: 'รายจ่ายประจำ', kindInstallment: 'หนี้ผ่อน',
    kindHint: 'ก้อนเดียว = จ่ายครั้งเดียวจบ · รายจ่ายประจำ = ค่าเช่า/บิล/สมาชิก (ไม่มีวันจบ) · หนี้ผ่อน = ผ่อนจนเป็นเจ้าของ (รถ/บ้าน)',
    freq: { weekly: 'ทุกสัปดาห์', monthly: 'ทุกเดือน', yearly: 'ทุกปี' },
    perCycle: 'ยอดต่อรอบ', perInstallment: 'ยอดต่องวด',
    totalInstallments: 'จำนวนงวดทั้งหมด', paidInstallments: 'จ่ายไปแล้ว (งวด)',
    installmentOf: (a, b) => `งวดที่ ${a}/${b}`,
    remaining: 'เหลือ', remainingBalance: 'ยอดคงเหลือ', paidOff: 'ผ่อนครบแล้ว 🎉',
    nextDue: 'ครบกำหนดถัดไป', payPeriod: 'จ่ายงวดนี้', payInstallment: 'จ่ายงวดนี้',
  ...
  settings: {
    ...
    shareBackup: 'สำรองขึ้นคลาวด์', shareFailed: 'แชร์ไฟล์สำรองไม่สำเร็จ ลองใหม่',
    savedToDownloads: 'บันทึกไฟล์สำรองไว้ในโฟลเดอร์ดาวน์โหลดแล้ว',
    importHint: 'นำเข้าไฟล์สำรอง .json, .xlsx หรือ .csv ที่เคยส่งออก', importDone: 'นำเข้าเสร็จแล้ว',
